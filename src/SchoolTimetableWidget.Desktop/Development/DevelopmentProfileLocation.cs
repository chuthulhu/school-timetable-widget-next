...
internal static class DevelopmentProfileLocation
{
    ...
    public static string? FromArguments(string[] args, string? environmentDirectory = null)
    {
#if DEBUG
        var argument = args.SingleOrDefault(a => a.StartsWith("--dev-profile-directory=", StringComparison.Ordinal));
        var supplied = argument is null ? environmentDirectory : argument["--dev-profile-directory=".Length..];
